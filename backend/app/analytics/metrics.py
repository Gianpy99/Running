...
def basic_metrics(workout: Workout) -> dict:
    ...
    # GPS/distance streams): derive averages and moving time from workout totals.
    no_speed_signal = not speeds
    if no_speed_signal and workout.distance_m > 0 and workout.duration_s > 0:
    ...
    return {
        "distance_m": round(workout.distance_m, 1),
        "duration_s": round(workout.duration_s, 1),
